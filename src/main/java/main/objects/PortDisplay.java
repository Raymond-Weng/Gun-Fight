...
public class PortDisplay extends GameObject {
    private Game game;
    private Graphics graphics;
    private String text;

    public PortDisplay(Game game, String port){
        this.game = game;
        this.text = port;
    }
    ...
    public Image render() {
        ...
        graphics.drawString(text,
                ...
                (game.getCamera().getDisplayArea().getIntHeight()) / 2 + graphics.getFontMetrics().getFont().getSize());;
        graphics.dispose();
        return image;
    }
